...
class User:
    ...
    def __init__(self, private_key, name, domain, ip):
        ...
        :param private_key: (str) private key of the user. This is not save in the class is just used to generate
                            a public_key. In other functions the private_key must be used to sign transactions
    ...
    def get_all_details_from(self, user, private_key):
        """
    ...
    def get_detail_from_generator(self, user, detail_id, private_key):
        """
