...
flags.DEFINE_string("worker_name", None, "worker name: chief, worker1, worker2, worker3... worker18, worker19")
flags.DEFINE_string("file_X", None, "file name: X_Worker_1, X_Worker_2, X_Worker_3... X_Worker_20")
flags.DEFINE_string("file_Y", None, "file name: Y_Worker_1, Y_Worker_2, Y_Worker_3... Y_Worker_20")
